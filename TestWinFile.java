...
public class TestWinFile {
	...
	public void test_winInRow()
	{
		...
		assertTrue("You win in this condition || 1, 1 || game board in console",a.checkRow(1, 1, 1));
		assertTrue("You win in this condition || 1, 2 || game board in console",a.checkRow(1, 2, 1));
		assertTrue("You win in this condition || 1, 3 || game board in console",a.checkRow(1, 3, 1));
		assertTrue("You win in this condition || 1, 4 || game board in console",a.checkRow(1, 4, 1));
		assertTrue("You win in this condition || 1, 0 || game board in console",a.checkRow(1, 0, 1));
		//assertFalse("You do not win in this condition || 2, 2 || Game board in console", a.checkRow(2,2));
		assertTrue("The game is over", a.checkWin(1, 3));
	...
	public void test_winCol() 
	{
		...
		assertTrue("The game is over", a.checkWin(2, 1));
	}
	...
	public void test_winDiag()
	{
		...
		assertTrue("The game is over", a.checkWin(2, 2));
	}
